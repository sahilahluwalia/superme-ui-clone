...
export default function Header() {
  return (
    <header className="w-full px-4  items-center justify-between">
      <div className="flex justify-between   flex-col md:flex-row items-center gap-2 sm:gap-5 md:gap-10 w-full">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            className="bg-black text-white font-bold px-5 py-1.5 rounded-full text-sm hover:bg-gray-800 cursor-pointer whitespace-nowrap"
          >
            Sign Up
          </button>
        </div>
